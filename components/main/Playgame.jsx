...
export default function Playgame() {
  const data = [
    {
      ...
      dev2: "CSS",
      dev3: "JS",
      demo: "https://keplar-404.github.io/board-game/",
      github: "https://github.com/keplar-404/board-game",
    },
    {
      ...
      dev2: "CSS",
      dev3: "JS",
      demo: "https://keplar-404.github.io/Guess-the-number/",
      github: "https://github.com/keplar-404/Guess-the-number",
    },
  ];
  ...
  return (
    <>
      <div className="text-black sm:mt-[-980px] xl:mt-[-60rem] w-full flex justify-center items-center">
